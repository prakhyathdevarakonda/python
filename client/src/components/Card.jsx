...
const Card = ({ card, title, restStyles, cardRef, playerTwo }) => {
  return (
    ...
    <div className={`${styles.cardPointContainer} sm:left-[23.2%] left-[22%] ${styles.flexCenter}`}>
        <p className={`${styles.cardPoint} text-yellow-400`}>{card.att}</p>
      </div>
      <div className={`${styles.cardPointContainer} sm:right-[17.2%] right-[15%] ${styles.flexCenter}`}>
